...
$product= new Product();
	...
	$user->updateUser(strtoupper($name),$DOB,$cnic,$oldPassword,$phone,strtoupper($_POST["gender"]),1,1,strtoupper($province),strtoupper($district),strtoupper($city),strtoupper($tehsil),strtoupper($comAddress),$imageResult[1],$_SESSION["user"]);
	}
}
							...
							<p><span class="error">* required field.</span></p>
                            	<div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                    	<input type="text" name="name" onkeypress="return isCharacter(event)" maxlength="30" value="<?php echo $name=$productInfo[0]["user_name"]; ?>" onKeyPress="return isCharacter(event)">
                                    </div>	
									<div class="col-lg-3 col-md-3 col-sm-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                    	<input type="text" name="CNIC" onkeypress="return isNumber(event)" maxlength="13" value="<?php echo $cnic=$productInfo[0]["cnic"]; ?>" onKeyPress="return isNumber(event)">
                                    </div>	
									<div class="col-lg-3 col-md-3 col-sm-3">
								...
								<div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                    	<input type="text" onkeypress="return isNumber(event)" maxlength="11" name="phone" value="<?php echo $phone=$productInfo[0]["user_phone"]; ?>" onKeyPress="return isNumber(event)">
                                    </div>	
									<div class="col-lg-3 col-md-3 col-sm-3">
								...
								<div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                    	<input type="text" onkeypress="return isCharacter(event)" maxlength="15" name="province" value="<?php echo $province=$productInfo[0]["user_province"]; ?>" onKeyPress="return isCharacter(event)">
                                    </div>	
									<div class="col-lg-3 col-md-3 col-sm-3">
								...
								<div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                    	<input type="text" onkeypress="return isCharacter(event)" maxlength="15" name="district" value="<?php echo $district=$productInfo[0]["user_district"]; ?>" onKeyPress="return isCharacter(event)">
                                    </div>	
										<div class="col-lg-3 col-md-3 col-sm-3">
								...
								<div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                    	<input type="text" onkeypress="return isCharacter(event)" maxlength="15" name="city" value="<?php echo $city=$productInfo[0]["user_city"]; ?>" onKeyPress="return isCharacter(event)">
                                    </div>	
									<div class="col-lg-3 col-md-3 col-sm-3">
								...
								<div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                    	<input type="text" onkeypress="return isCharacter(event)" maxlength="15" name="tehsil" value="<?php echo $tehsil=$productInfo[0]["user_tehsil"]; ?>" onKeyPress="return isCharacter(event)">
                                    </div>	
									<div class="col-lg-3 col-md-3 col-sm-3">
								...
								<div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                    	<input type="text" maxlength="50" name="comAddress" value="<?php echo $comAddress=$productInfo[0]["user_comAddress"]; ?>">
                                    </div>	
										<div class="col-lg-3 col-md-3 col-sm-3">
