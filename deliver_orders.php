...
session_start();	
if(isset($_SESSION['user']) && $_SESSION['userType']==2){include($p."Templates/admin_loggedin_header.php");}
			...
			<div class="row content">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                	<div class="breadcrumbs">
                    	<p><a href="bhai_panel.php">Home</a> <i class="icons icon-right-dir"></i> Delivered Orders</p>
                    </div>
                </div>
                
				<!-- Main Content -->
				<section class="main-content col-lg-12 col-md-12 col-sm-12" style="align:centre;">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
							...
							<table class="order-table">
								...
								<tr>
									...
									<td ><p><?php echo $data["order_id"];?></p></td>
									...
									<td><span class="price"><?php if($data["order_status"]==1){echo "Delivered";} ?></span></td>
