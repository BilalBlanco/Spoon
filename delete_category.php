...
if (isset($_POST['delete'])){
	//print_r($_POST);
	$product = new Product();
	$product->addLog($_SESSION['user'],"Category Deleted",$_POST["txtId"]);
	$result=$product->deleteCategory($_POST["txtId"]);
  ...
  <table class="table table-bordered">
    ...
    <tbody>
      <?php 
        ...
        <input type="button" name ="update "  class="btn btn-info update" value="Update" onClick="setId(<?php echo $result["category_id"]; ?>)" />
         <input type="submit" name ="delete" class="btn btn-danger" value="Delete" onClick="setId(<?php echo $result["category_id"]; ?>)" />
...
<script>
	...
	$(".update").click(function(){
	    $("#productForm").attr("action","update_category.php");
		$("#productForm").submit();  
