...
<head>
    ...
    <body>
		...
		<div class="container">
			...
			session_start();
			if(isset($_SESSION['user']) && $_SESSION['userType']==1){include($p."Templates/loggedin_header.php");}
			...
			<div class="row content">
				...
				<section class="main-content col-lg-9 col-md-9 col-sm-9">
                  <form method="post">  
                    ...
                    <div class="row">
                    	<?php $asd=0; if(!empty($_POST["txtId123456"])){$asd=$_POST["txtId123456"];$_SESSION['currentOrderId1']=$_POST["txtId123456"];}?>
                        <div class="col-lg-12 col-md-12 col-sm-12">
							...
							$orderInfo=$order->getOrderDetails($_SESSION['currentOrderId']);
                            ...
                            <table class="orderinfo-table">
                                ...
                                <tr>
                                	<th>Total</th>
                                    <td><span class="price"><?php echo $data["price"]." Estimated PKR"; ?></span></td>
                                </tr>                    
					 ...
					 <?php
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <table class="orderinfo-table">
                                ...
                                <tr>
                                	<th>Title</th>
                                    <td><?php if($result[0]["ugender"]=="Male" || $result[0]["ugender"]=="MALE"){echo "Mr.";}else if($result[0]["ugender"]=="Female" || $result[0]["ugender"]=="FEMALE"){echo "Miss/Mrs.";}else{echo "Other";}?></td>
                                </tr>
                         ...
                         <div class="col-lg-12 col-md-12 col-sm-12">
							...
							<div class="tabs">
                                ...
                                <div class="tab-content no-padding">
									...
									<div>
									<?php $order=new Order();
											$orderInfo=$order->getOrderRecipt($_SESSION['currentOrderId1']);
											//print_r($orderInfo);
												
											foreach($orderInfo as $data){
												//print_r($value);
												//echo $data["recipt_src"];
											?>
                    ...
                    <?php }else{?><<script>window.location.replace("order_list.php");</script><?php } ?>    
                    </form>
				</section>
				<!-- /Main Content -->
