			...
			<div class="row content">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                	<div class="breadcrumbs">
                    	<p><a href="admin_panel.php">Home</a> <i class="icons icon-right-dir"></i> Admin</p>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
							...
							<table class="order-table">
								...
								<?php
								$productInfo=null;
								$productInfo=$product->getLogs();
								foreach($productInfo as $data){
								?>
								<tr>
								
									<td class="order-number"><p><a href="#"><?php echo $data["logid"];?></a></p></td>
									<td><p><?php echo $data["admin"];?></p></td>
									<td><p><?php echo $data["logdes"];?></p></td>
									<td><p><?php echo $data["itemid"];?></p></td>
