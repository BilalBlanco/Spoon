                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
							...
							<table class="order-table">
								...
								$productInfo=null;
								$productInfo=$order->getNewOrdersDetails1($_SESSION["user"]);
								...
								<tr>
									...
									<td>
										...
										<input type="button" name ="update "  class="btn btn-info update" value="<?php echo $_SESSION['currentOrderId']=$data["ID"]; ?>" onClick="setId(<?php echo $data["ID"]; ?>)" />
									</td>
									<td><p><?php echo $data["time"];?></p></td>
									<td><p><?php echo $data["name"];?></p></td>
									<td><p><?php echo $data["phone"];?></p></td>
									<td><p><?php echo $data["address"];?></p></td>
									<td><p><?php  if($data["status"]==0){echo "Not Delivered";}elseif ($data["status"]==1){echo "Delivered";}?></p></td>
									<td><p><?php echo $data["dtime"];?></p></td>
